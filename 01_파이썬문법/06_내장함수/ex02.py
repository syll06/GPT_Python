...
money = 10000
price = 3000
result = divmod(money, price) # result : (3, 1000)
...
print('round(1.3) : {}'.format( round(1.4) ))
print('round(1.55) : {}'.format( round(1.55, 1) ))
print('round(2.675) : {}'.format( round(2.675, 2) ))  # 오차 현상
